...
saveRDS(mar_model1, 'epinow_model_fits/mar_model_infections.rds')
...
saveRDS(mar_model2, 'epinow_model_fits/mar_model_cases.rds')
...
saveRDS(mar_model3, 'epinow_model_fits/mar_model_hospitalisations.rds')
...
saveRDS(mar_model4, 'epinow_model_fits/mar_model_deaths.rds')
...
saveRDS(mar_model2_delay, 'epinow_model_fits/mar_model_cases_delay.rds')
...
saveRDS(mar_model3_delay, 'epinow_model_fits/mar_model_hospitalisations_delay.rds')
...
saveRDS(mar_model4_delay, 'epinow_model_fits/mar_model_deaths_delay.rds')

####### Pre-fitted models #########
# Confirm code above is correct and runs, before loading pre-fitted models

mar_model1 <- readRDS('epinow_model_fits/mar_model_infections.rds')
mar_model2 <- readRDS('epinow_model_fits/mar_model_cases.rds') # model fit to cases without delay
mar_model3 <- readRDS('epinow_model_fits/mar_model_hospitalisations.rds') # model fit to hospitalisations without delay
mar_model4<- readRDS('epinow_model_fits/mar_model_deaths.rds') # model fit to deaths without delay
mar_model2_delay <- readRDS('epinow_model_fits/mar_model_cases_delay.rds') # model fit to cases with delay
mar_model3_delay <- readRDS('epinow_model_fits/mar_model_hospitalisations_delay.rds') # model fit to hospitalisations with delay
mar_model4_delay <- readRDS('epinow_model_fits/mar_model_deaths_delay.rds') # model fit to deaths with delay
...
mar_summary1 <- mar_model1$estimates$summarised
mar_summary2 <- mar_model2$estimates$summarised
mar_summary3 <- mar_model3$estimates$summarised
mar_summary4 <- mar_model4$estimates$summarised
mar_summary2_delay <- mar_model2_delay$estimates$summarised
mar_summary3_delay <- mar_model3_delay$estimates$summarised
mar_summary4_delay <- mar_model4_delay$estimates$summarised
